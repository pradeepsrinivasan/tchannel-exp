...
public class Table {
  ...
  protected String __string(int offset) {
    ...
    if (bb.hasArray()) {
      return new String(bb.array(), bb.arrayOffset() + offset + Constants.SIZEOF_INT, bb.getInt(offset), FlatBufferBuilder.utf8charset);
    } else {
      ...
      bb.position(offset + Constants.SIZEOF_INT);
      bb.get(copy);
